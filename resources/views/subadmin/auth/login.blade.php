...
<head>
    ...
    <title>Sub Administrative / Login - {{env('APP_NAME')}}</title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Login to Your Sub Administrative
                                            Account</h5>
                                        @if (Session::has('msg'))
                                    ...
                                    <form class="auth-form login-form" action="{{ route('subadmin.login') }}"
                                        method="POST">
                                        @csrf
