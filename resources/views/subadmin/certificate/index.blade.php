        ...
        <div class="certInner">
            ...
            <div class="certificateInfo">
                <div class="certificateInfoItem">
                    ...
                    <span class="value" style="text-align: center;">{{ $student->name }}</span>
                </div>
                <div class="certificateInfoItem">
                    <span class="label">Father Name</span>
                    <span class="value" style="text-align: center;">{{ $student->father_name }}</span>
                </div>
                <div class="certificateInfoItem">
                    <span class="label">D.O.B</span>
                    <span class="value" style="text-align: center;">{{ $student->dob }}</span>
                </div>
                <div class="certificateInfoItem">
                    <span class="label">Registration No. is</span>
                    <span class="value" style="text-align: center;">{{ $student->enrollment_no }}</span>
                    <span class="label">Successfully Completed the</span>
                </div>
                <div class="certificateInfoItem">
                    <span class="label">Course</span>
                    <span class="value" style="text-align: center;">{{ $course->course_name }}</span>
                </div>
                <div class="certificateInfoItem">
                    <span class="label">at Study Center</span>
                    <span class="value" style="text-align: center;">{{ $student->org_name }}</span>
                </div>
                <div class="certificateInfoItem">
                ...
                <div class="certificateInfoItem">
                    ...
                    <span class="value" style="text-align: center;">{{ $marksObtainedInPercent }}%</span>
                    <span class="label">Marks Grade</span>
                    <span class="value" style="text-align: center;">{{ $grade }}</span>
                </div>
            </div>
            ...
            <div class="controlExamination">
                <!-- <span>Signature</span> -->
                <img src="{{asset('images/signature.png')}}" alt="Signature" style="position: absolute; bottom: 25px; left: 50%; transform: translateX(-50%); width: 140px; z-index: 10;">
