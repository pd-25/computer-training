    ...
    <div class="certificate-container">
        ...
        <div class="footer">
            ...
            <div class="signature-group" style="position: relative;">
                ...
                <img src="{{ asset('images/signature.png') }}" alt="Signature" style="position: absolute; bottom: 45px; left: 50%; transform: translateX(-50%); width: 130px; z-index: 3; pointer-events: none;">
