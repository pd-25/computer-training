...
<body>
    <div class="id-card" id="idCard">
        ...
        <div class="details">
            ...
            <div class="info-row">
                <span class="label">Franchise ID</span>
                <span class="value">{{ $subadmin->subadmin_unique_id }}</span>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span class="value">Authorized Partner</span>
            </div>
        </div>
    ...
    <script>
        document.getElementById("downloadBtn").addEventListener("click", function() {
            ...
            html2canvas(idCard, {
                ...
                link.href = imgData;
                link.download = "ID_Card_{{ $subadmin->name ?? 'franchise' }}.png";
                link.click();
