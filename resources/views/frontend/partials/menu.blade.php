<ul class="navbar-nav text-center w-100 justify-content-center" style="background-color: #182b45;">
    ...
    <li class="nav-item {{ Route::currentRouteName() == 'frontend.verification' ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('frontend.verification') }}">Student Zone</a>
    </li>

    <li class="nav-item {{ Route::currentRouteName() == 'frontend.franchise' ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('frontend.franchise') }}">Get Franchise</a>
    </li>
    ...
    <li class="nav-item dropdown view">
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item {{ Route::currentRouteName() == 'frontend.gallery' ? 'active' : '' }}" href="{{ route('frontend.gallery') }}">Gallery</a></li>
